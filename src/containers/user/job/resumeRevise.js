...
export class ResumeRevise extends Component {
        ...
        return (
            ...
            <View>
                ...
                <HeaderComponent
                    ...
                    headerTitle={<Text style={{fontSize: 18}}>简历修改</Text>}
                />
                ...
                <KeyboardAwareScrollView>
                    ...
                    <ScrollView>
                        ...
                        {/*提示消息*/}
                        <Text style={styles.system}>添加您的简历，企业才能看的到你哦!</Text>
                        ...
                        <View style={styles.item}>
                            ...
                            <View style={styles.info}>
                                <View style={styles.info}>
                                    ...
                                    <Radio data={['男','女']} select={(data)=>this.setState({sex: data})}/>
                                </View>
                            </View>
                            ...
                            <View style={styles.info}>
                                <Text style={styles.infoTitle}>工作经历</Text>
                                <TextInput
                                    autoCapitalize='none'
                                    placeholder="(选填)工作经历大大提高面试率哦！"
                                    placeholderTextColor="#ccc"
                                    multiline= { true }
                                    maxLength={5000}
                            ...
                            <View style={styles.info}>
                                <Text style={styles.infoTitle}>教育经历</Text>
                                <TextInput
                                    autoCapitalize='none'
                                    placeholder="(选填)教育经历大大提高面试率哦！"
                                    placeholderTextColor="#ccc"
                                    multiline= { true }
                                    maxLength={5000}
                                    style={styles.infoInputAeaa}
