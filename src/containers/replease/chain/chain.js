...
export class Replease12to1 extends Component {
    ...
    doSubmit = ()=>{
        ...
        (repleaseInfo.price==null)||(repleaseInfo.price=='')?message.push('请填写投资金额!'):null;
        ...
        if(message.length>0){
            ...
            Http.post(Ip+'api/chain/create', repleaseInfo ,{'Content-Type': 'application/json'},)
                .then( res=>{
                    if(res.success){
                        this.setState({
                            showLoad: false
                ...
                <KeyboardAwareScrollView>
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.item}>
                            ...
                            <View style={styles.info}>
                                <Text style={styles.infoTitle}>投资金额(万元)</Text>
                                <TextInput
                                    autoCapitalize='none'
                                    placeholder="请填写投资金额"
                                    placeholderTextColor="#ccc"
