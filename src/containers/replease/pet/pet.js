...
import { PetType } from "../../../components/picker";
...
export class Replease8to1 extends Component {
    ...
    doSubmit = ()=>{
        ...
        repleaseInfo.type==null?message.push('请选择类型!'):null;
        ...
        if(message.length>0){
            ...
            Http.post(Ip+'api/pet/create', repleaseInfo ,{'Content-Type': 'application/json'},)
                .then( res=>{
                    if(res.success){
                        this.setState({
                            showLoad: false
                ...
                <KeyboardAwareScrollView>
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.item}>
                            ...
                            <View style={styles.info}>
                                <Text style={styles.infoTitle}>年龄(月)</Text>
                                <TextInput
                                    autoCapitalize='none'
                                    placeholder="请填写年龄"
                                    placeholderTextColor="#ccc"
                        ...
                        <View style={styles.item}>
                            ...
                            <View style={styles.info}>
                                <View style={styles.info}>
                                    <Text style={styles.infoTitle}>性别</Text>
                                    <Radio data={['公','母', '公/母']} select={(data)=>this.setState({sex: data})}/>
                                </View>
                            </View>

                            <View style={styles.info}>
                                <View style={styles.info}>
                                    <Text style={styles.infoTitle}>驱虫情况</Text>
                                    <Radio data={['已驱','未驱']} select={(data)=>this.setState({insect: data})}/>
                                </View>
                            </View>

                            <View style={styles.info}>
                                <View style={styles.info}>
                                    <Text style={styles.infoTitle}>疫苗情况</Text>
                                    <Radio data={['1针','2针','3针','未打']} select={(data)=>this.setState({vaccine: data})}/>
                                </View>
                            </View>
