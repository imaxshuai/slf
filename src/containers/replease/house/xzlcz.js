...
import {HouseBaseInfo} from "../../../components/picker";
...
export class Replease1to8 extends Component {
    ...
    doSubmit = ()=>{
        ...
        (repleaseInfo.community_name==null)||(repleaseInfo.community_name=='')?message.push('请填写写字楼名!'):null;
                ...
                <KeyboardAwareScrollView>
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.item}>
                            ...
                            <View style={styles.info}>
                                <Text style={styles.infoTitle}>写字楼名</Text>
                                <TextInput
                                    autoCapitalize='none'
                                    placeholder="请填写字楼名称"
                                    placeholderTextColor="#ccc"
                        ...
                        <View style={styles.item}>
                            ...
                            <View style={styles.info}>
                                <Text style={styles.infoTitle}>租金(元/㎡/天)</Text>
                                <TextInput
                                    autoCapitalize='none'
                                    placeholder="请填写租金"
                                    placeholderTextColor="#ccc"
