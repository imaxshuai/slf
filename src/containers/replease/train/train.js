...
import {CarColor, CardYear, EsPhoneBrand, EsPhoneType, Jiaoqiangxian, Shangyexian} from "../../../components/picker";
...
export class Replease7to1 extends Component {
    ...
    doSubmit = ()=>{
        ...
        let repleaseInfo = {
            ...
            company_name: this.refs.company_name._lastNativeText,
        ...
        (repleaseInfo.company_name==null)||(repleaseInfo.company_name=='')?message.push('请填写机构名称!'):null;
        ...
        if(message.length>0){
            ...
            Http.post(Ip+'api/train/create', repleaseInfo ,{'Content-Type': 'application/json'},)
                .then( res=>{
                    if(res.success){
                        this.setState({
                            showLoad: false
                ...
                <KeyboardAwareScrollView>
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.item}>
                            ...
                            <View style={styles.info}>
                                <Text style={styles.infoTitle}>机构名称</Text>
                                <TextInput
                                    autoCapitalize='none'
                                    placeholder="请填写机构名称"
                                    placeholderTextColor="#ccc"
