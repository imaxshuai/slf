...
class BusinessDetail extends Component{
    ...
    componentDidMount(){
        this.props.businessActions.getBusiness(this.props.navigation.state.params);
    }
            ...
            <View style={styles.container}>
                ...
                {infos.length>1
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.bodyInfoDbusinessribe}>
                            <Text style={styles.bodyInfoDbusinessribeTitle}>详情描述</Text>
                            ...
                            <View>
                                <Text style={styles.bodyInfoDbusinessribeContent}>{infos[5][1]}</Text>
                            </View>
                        </View>
...
const styles = StyleSheet.create({
    ...
    /*房子描述*/
    bodyInfoDbusinessribe: {
        marginTop: 10,
        padding: 10,
        backgroundColor: '#fff',
    },
    bodyInfoDbusinessribeTitle: {
        fontSize: 18,
        fontWeight: '500',
        paddingTop: 5,
    },
    bodyInfoDbusinessribeContent: {
        fontSize: 14,
        color: '#999',
        lineHeight: 30,
    },
