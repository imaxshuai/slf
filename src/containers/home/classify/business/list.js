...
class BusinessList extends Component{
    ...
    componentDidMount(){
        ...
        this.props.businessActions.getBusinessList(filters, {data: []});
    }

    componentWillUnmount(){
        this.props.businessActions.getBusinessList('no', {data: []});

    }

    getBusinessListByFilter = (data)=>{
        ...
        if(typeof(data[1])=='string'){
            ...
            if(data[1]==null){
                ...
                }else if(data[0]=='business_size'){
                    filters.max_business_size = null;
                    filters.min_business_size = null;
                }
            }else{
        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <AreaModel
                    ...
                    chooseArea={(area)=>this.getBusinessListByFilter(area)}
                ...
                <TypeModel
                    ...
                    chooseType={(price)=>this.getBusinessListByFilter(price)}
                ...
                {params.filter[1]!=null?
                    (
                        <TypeModel
                            ...
                            chooseType={(business_type)=>this.getBusinessListByFilter(business_type)}
                ...
                {params.filter[2]!=null?(
                    params.filter[2].length>1?(
                        <OtherModel
                            ...
                            chooseFilter={(data)=>this.getBusinessListByFilter(data)}
                        ...
                        <TypeModel
                            ...
                            chooseType={(other)=>this.getBusinessListByFilter(other)}
                            bgClickHideModel={()=>this.setState({showTypeModel: false})}
                        />
                    )
                ): null}
                <Spinner
                    ...
                    isVisible={(this.props.businessList.data.length<=0)&&(this.props.businessList.isEnd==false)}
                    size={50}
                    type='9CubeGrid'
                    color='red'
                />
                ...
                <FlatList
                    ...
                    data={this.props.businessList['data']}
                    keyExtractor={(item)=>item.id}
                    initialNumToRender={5}
                    onEndReachedThreshold={0.3}
                    onEndReached={this._getMoreBusiness.bind(this)}
