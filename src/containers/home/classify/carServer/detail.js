...
class CarServerDetail extends Component{

    static navigationOptions = {
        header: null,
    };
    componentDidMount(){
        this.props.carServerActions.getCarServer(this.props.navigation.state.params);
    }

    componentWillUnmount(){
        this.props.carServerActions.getCarServer('no');
    }
            ...
            <View style={styles.container}>
                ...
                {infos.length>1
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.bodyInfoDcarServerribe}>
                            <Text style={styles.bodyInfoDcarServerribeTitle}>详情描述</Text>
                            ...
                            <View>
                                <Text style={styles.bodyInfoDcarServerribeContent}>{infos[5][1]}</Text>
                            </View>
                        </View>
...
const styles = StyleSheet.create({
    ...
    /*房子描述*/
    bodyInfoDcarServerribe: {
        marginTop: 10,
        padding: 10,
        backgroundColor: '#fff',
    },
    bodyInfoDcarServerribeTitle: {
        fontSize: 18,
        fontWeight: '500',
        paddingTop: 5,
    },
    bodyInfoDcarServerribeContent: {
        fontSize: 14,
        color: '#999',
        lineHeight: 30,
    },
