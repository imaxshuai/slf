...
import * as chainActions from '../../../../redux/actions/chain';
...
class ChainList extends Component{
    ...
    componentDidMount(){
        ...
        this.props.chainActions.getChainList(filters, {data: []});
    }

    componentWillUnmount(){
        this.props.chainActions.getChainList('no', {data: []});
    ...
    getChainListByFilter = (data)=>{
        ...
        if(typeof(data[1])=='string'){
            ...
            if(data[1]==null){
                ...
                }else if(data[0]=='chain_size'){
                    filters.max_chain_size = null;
                    filters.min_chain_size = null;
                }
            }else{
        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <AreaModel
                    ...
                    chooseArea={(area)=>this.getChainListByFilter(area)}
                ...
                <TypeModel
                    ...
                    chooseType={(price)=>this.getChainListByFilter(price)}
                ...
                {params.filter[1]!=null?
                    (
                        <TypeModel
                            ...
                            chooseType={(chain_type)=>this.getChainListByFilter(chain_type)}
                ...
                {params.filter[2]!=null?(
                    params.filter[2].length>1?(
                        <OtherModel
                            ...
                            chooseFilter={(data)=>this.getChainListByFilter(data)}
                        ...
                        <TypeModel
                            ...
                            chooseType={(other)=>this.getChainListByFilter(other)}
                            bgClickHideModel={()=>this.setState({showTypeModel: false})}
                        />
                    )
                ): null}
                <Spinner
                    ...
                    isVisible={(this.props.chainList.data.length<=0)&&(this.props.chainList.isEnd==false)}
                    size={50}
                    type='9CubeGrid'
                    color='red'
                />
                ...
                <FlatList
                    ...
                    data={this.props.chainList['data']}
                    keyExtractor={(item)=>item.id}
                    initialNumToRender={5}
                    onEndReachedThreshold={0.3}
                    onEndReached={this._getMoreChain.bind(this)}
...
const mapDispatchToProps = (dispatch)=>{
    return {
        ...
        chainActions: bindActionCreators(chainActions, dispatch),
