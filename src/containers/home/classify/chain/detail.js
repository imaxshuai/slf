...
class ChainDetail extends Component{
    ...
    componentDidMount(){
        this.props.chainActions.getChain(this.props.navigation.state.params);
    }

    componentWillUnmount(){
        this.props.chainActions.getChain('no');
    }
            ...
            <View style={styles.container}>
                ...
                {infos.length>1
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.bodyInfoDchainribe}>
                            <Text style={styles.bodyInfoDchainribeTitle}>详情描述</Text>
                            ...
                            <View>
                                <Text style={styles.bodyInfoDchainribeContent}>{infos[5][1]}</Text>
                            </View>
                        </View>
...
const styles = StyleSheet.create({
    ...
    bodyInfoDchainribeTitle: {
        fontSize: 18,
        fontWeight: '500',
        paddingTop: 5,
    },
    bodyInfoDchainribeContent: {
        fontSize: 14,
        color: '#999',
        lineHeight: 30,
    },
