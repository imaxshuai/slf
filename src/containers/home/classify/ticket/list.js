...
class TicketList extends Component{
    ...
    componentDidMount(){
        ...
        this.props.ticketActions.getTicketList(filters, {data: []});
    }

    componentWillUnmount(){
        this.props.ticketActions.getTicketList('no', {data: []});
    ...
    getTicketListByFilter = (data)=>{
        ...
        if(typeof(data[1])=='string'){
            ...
            if(data[1]==null){
                ...
                }else if(data[0]=='ticket_size'){
                    filters.max_ticket_size = null;
                    filters.min_ticket_size = null;
                }
            }else{
        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <AreaModel
                    ...
                    chooseArea={(area)=>this.getTicketListByFilter(area)}
                ...
                <TypeModel
                    ...
                    chooseType={(price)=>this.getTicketListByFilter(price)}
                ...
                {params.filter[1]!=null?
                    (
                        <TypeModel
                            ...
                            chooseType={(ticket_type)=>this.getTicketListByFilter(ticket_type)}
                ...
                {params.filter[2]!=null?(
                    params.filter[2].length>1?(
                        <OtherModel
                            ...
                            chooseFilter={(data)=>this.getTicketListByFilter(data)}
                        ...
                        <TypeModel
                            ...
                            chooseType={(other)=>this.getTicketListByFilter(other)}
                            bgClickHideModel={()=>this.setState({showTypeModel: false})}
                        />
                    )
                ): null}
                <Spinner
                    ...
                    isVisible={(this.props.ticketList.data.length<=0)&&(this.props.ticketList.isEnd==false)}
                    size={50}
                    type='9CubeGrid'
                    color='red'
                />
                ...
                <FlatList
                    ...
                    data={this.props.ticketList['data']}
                    keyExtractor={(item)=>item.id}
                    initialNumToRender={5}
                    onEndReachedThreshold={0.3}
                    onEndReached={this._getMoreTicket.bind(this)}
