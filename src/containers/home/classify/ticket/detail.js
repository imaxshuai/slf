...
class TicketDetail extends Component{
    ...
    componentDidMount(){
        this.props.ticketActions.getTicket(this.props.navigation.state.params);
    }
            ...
            <View style={styles.container}>
                ...
                {infos.length>1
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.bodyInfoDticketribe}>
                            <Text style={styles.bodyInfoDticketribeTitle}>详情描述</Text>
                            ...
                            <View>
                                <Text style={styles.bodyInfoDticketribeContent}>{infos[5][1]}</Text>
                            </View>
                        </View>
...
const styles = StyleSheet.create({
    ...
    bodyInfoDticketribeTitle: {
        fontSize: 18,
        fontWeight: '500',
        paddingTop: 5,
    },
    bodyInfoDticketribeContent: {
        fontSize: 14,
        color: '#999',
        lineHeight: 30,
    },
