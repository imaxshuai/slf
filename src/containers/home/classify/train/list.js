...
class TrainList extends Component{
    ...
    componentDidMount(){
        ...
        this.props.trainActions.getTrainList(filters, {data: []});
    }

    componentWillUnmount(){
        this.props.trainActions.getTrainList('no', {data: []});
    ...
    getTrainListByFilter = (data)=>{
        ...
        if(typeof(data[1])=='string'){
            ...
            if(data[1]==null){
                ...
                }else if(data[0]=='train_size'){
                    filters.max_train_size = null;
                    filters.min_train_size = null;
                }
            }else{
        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <AreaModel
                    ...
                    chooseArea={(area)=>this.getTrainListByFilter(area)}
                ...
                <TypeModel
                    ...
                    chooseType={(price)=>this.getTrainListByFilter(price)}
                ...
                {params.filter[1]!=null?
                    (
                        <TypeModel
                            ...
                            chooseType={(train_type)=>this.getTrainListByFilter(train_type)}
                ...
                {params.filter[2]!=null?(
                    params.filter[2].length>1?(
                        <OtherModel
                            ...
                            chooseFilter={(data)=>this.getTrainListByFilter(data)}
                        ...
                        <TypeModel
                            ...
                            chooseType={(other)=>this.getTrainListByFilter(other)}
                            bgClickHideModel={()=>this.setState({showTypeModel: false})}
                        />
                    )
                ): null}
                <Spinner
                    ...
                    isVisible={(this.props.trainList.data.length<=0)&&(this.props.trainList.isEnd==false)}
                    size={50}
                    type='9CubeGrid'
                    color='red'
                />
                ...
                <FlatList
                    ...
                    data={this.props.trainList['data']}
                    keyExtractor={(item)=>item.id}
                    initialNumToRender={5}
                    onEndReachedThreshold={0.3}
                    onEndReached={this._getMoreTrain.bind(this)}
