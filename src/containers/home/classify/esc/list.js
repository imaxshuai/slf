...
class EscList extends Component{
    ...
    componentDidMount(){
        ...
        this.props.escActions.getEscList(filters, {data: []});
    }

    componentWillUnmount(){
        this.props.escActions.getEscList('no', {data: []});
    ...
    getEscListByFilter = (data)=>{
        ...
        if(typeof(data[1])=='string'){
            ...
            if(data[1]==null){
                ...
                }else if(data[0]=='esc_size'){
                    filters.max_esc_size = null;
                    filters.min_esc_size = null;
                }
            }else{
        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <AreaModel
                    ...
                    chooseArea={(area)=>this.getEscListByFilter(area)}
                ...
                <TypeModel
                    ...
                    chooseType={(price)=>this.getEscListByFilter(price)}
                ...
                {params.filter[1]!=null?
                    (
                        <TypeModel
                            ...
                            chooseType={(esc_type)=>this.getEscListByFilter(esc_type)}
                ...
                {params.filter[2]!=null?(
                    params.filter[2].length>1?(
                        <OtherModel
                            ...
                            chooseFilter={(data)=>this.getEscListByFilter(data)}
                        ...
                        <TypeModel
                            ...
                            chooseType={(other)=>this.getEscListByFilter(other)}
                            bgClickHideModel={()=>this.setState({showTypeModel: false})}
                        />
                    )
                ): null}
                <Spinner
                    ...
                    isVisible={(this.props.escList.data.length<=0)&&(this.props.escList.isEnd==false)}
                    size={50}
                    type='9CubeGrid'
                    color='red'
                />
                ...
                <FlatList
                    ...
                    data={this.props.escList['data']}
                    keyExtractor={(item)=>item.id}
                    initialNumToRender={5}
                    onEndReachedThreshold={0.3}
                    onEndReached={this._getMoreEsc.bind(this)}
