...
import * as lifeActions from '../../../../redux/actions/life';
...
class LifeList extends Component{
    ...
    componentDidMount(){
        ...
        this.props.lifeActions.getLifeList(filters, {data: []});
    }

    componentWillUnmount(){
        this.props.lifeActions.getLifeList('no', {data: []});
    ...
    getLifeListByFilter = (data)=>{
        ...
        if(typeof(data[1])=='string'){
            ...
            if(data[1]==null){
                ...
                }else if(data[0]=='life_size'){
                    filters.max_life_size = null;
                    filters.min_life_size = null;
                }
            }else{
        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <AreaModel
                    ...
                    chooseArea={(area)=>this.getLifeListByFilter(area)}
                ...
                <TypeModel
                    ...
                    chooseType={(price)=>this.getLifeListByFilter(price)}
                ...
                {params.filter[1]!=null?
                    (
                        <TypeModel
                            ...
                            chooseType={(life_type)=>this.getLifeListByFilter(life_type)}
                ...
                {params.filter[2]!=null?(
                    params.filter[2].length>1?(
                        <OtherModel
                            ...
                            chooseFilter={(data)=>this.getLifeListByFilter(data)}
                        ...
                        <TypeModel
                            ...
                            chooseType={(other)=>this.getLifeListByFilter(other)}
                            bgClickHideModel={()=>this.setState({showTypeModel: false})}
                        />
                    )
                ): null}
                <Spinner
                    ...
                    isVisible={(this.props.lifeList.data.length<=0)&&(this.props.lifeList.isEnd==false)}
                    size={50}
                    type='9CubeGrid'
                    color='red'
                />
                ...
                <FlatList
                    ...
                    data={this.props.lifeList['data']}
                    keyExtractor={(item)=>item.id}
                    initialNumToRender={5}
                    onEndReachedThreshold={0.3}
                    onEndReached={this._getMoreLife.bind(this)}
