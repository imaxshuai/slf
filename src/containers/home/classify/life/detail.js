...
class LifeDetail extends Component{
    ...
    componentDidMount(){
        this.props.lifeActions.getLife(this.props.navigation.state.params);
    }

    componentWillUnmount(){
        this.props.lifeActions.getLife('no');
    }
            ...
            <View style={styles.container}>
                ...
                {infos.length>1
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.bodyInfoDliferibe}>
                            <Text style={styles.bodyInfoDliferibeTitle}>详情描述</Text>
                            ...
                            <View>
                                <Text style={styles.bodyInfoDliferibeContent}>{infos[5][1]}</Text>
                            </View>
                        </View>
...
const styles = StyleSheet.create({
    ...
    bodyInfoDliferibeTitle: {
        fontSize: 18,
        fontWeight: '500',
        paddingTop: 5,
    },
    bodyInfoDliferibeContent: {
        fontSize: 14,
        color: '#999',
        lineHeight: 30,
    },
